        ...
        <div className='col-lg'>
          <div id='accordion'>
            ...
            <div className='card'>
              ...
              >
                <div className='card-body'>
                  I could create You a website for your kickstart, our your long
            ...
            <div className='card'>
              ...
              >
                <div className='card-body'>
                  My plan is to create native web applications based on React
